...
def render_packer_file(template_folder_path: str, tmp_path: str, config: PackerConfig, node: ProxmoxNode) -> None:
    # render
    template = Environment(loader=FileSystemLoader(
        os.path.join(template_folder_path, 'jinja_templates'))
